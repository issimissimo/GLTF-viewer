 ...
 */
function default_1({ exclude = undefined, include = DEFAULT_SHADERS, defaultExtension = DEFAULT_EXTENSION, warnDuplicatedImports = true } = {}) {
    let config;
    ...
    return {
        ...
        transform(source, shader) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                if (filter(shader))
                    return yield (0, vite_1.transformWithEsbuild)((0, loadShader_1.default)(source, shader, defaultExtension, warnDuplicatedImports), shader, {
